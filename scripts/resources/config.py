...
MAX_DUPLICATION_RISK = int(os.getenv("RESOURCES_MAX_DUPLICATION_RISK", "40"))
MIN_TRUTHFULNESS_SCORE = int(os.getenv("RESOURCES_MIN_TRUTHFULNESS_SCORE", "90"))
MIN_INTENT_MATCH_SCORE = int(os.getenv("RESOURCES_MIN_INTENT_MATCH_SCORE", "70"))
...
PRODUCT_CAPABILITIES = {
    ...
    "key_features": [
        ...
        "Free to start, plans from $49/mo",
    ],
    "document_types": [
        "Invoices",
        "Bank statements",
